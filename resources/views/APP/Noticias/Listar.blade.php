...
@section('content')
    <input type="hidden" value="{{ route('noticia.listar') }}" id="rutaListar">
    <div id="content-wrapper" class="d-flex flex-column" style="margin-top: -70px;">
        <div class="row" style="">
            <div class="col-xl-6">
                <h1 class="page-header" style="margin-top: 20px;">Listar Noticias</h1>
            </div>
        </div>
    ...
    @section('vendor-script')
        ...
        <script src="{{ asset('assets/js/tablaNoticias.js') }}"></script>
    @endsection
