$(function(){
    ...
    urlpendiente = $('#otPendientes').val()
    urllista = $('#otLista').val()
    urlpresupuesto = $('#otPresupuesto').val();
    urlnoaprobada = $('#otNoAprobada').val();
    "use strict";    
    $.ajax({
        url: urllista,
        method: "GET",
        success: function(data){
            $("label[for='listo']").text(data[0]['total']);
        }
    });
    $.ajax({
        url: urlpendiente,
        method: "GET",
        success: function(data){
            $("label[for='pendiente']").text(data[0]['total']);
        }
    });
    $.ajax({
        url: urlnoaprobada,
        method: "GET",
        success: function(data){
            $("label[for='noAprobada']").text(data[0]['total']);
        }
    });
    $.ajax({
        url: urlpresupuesto,
        method: "GET",
        success: function(data){
            $("label[for='presupuesto']").text(data[0]['total']);
        }
    });
    // notification popup
    ...
    toastr['info']('Hola, Bienvenido a Eberlein.'); 
