$(document).ready(function () {
    ...
    function validarPrint() {
        if ($("#id").val() == "") {
            ...
            print = $("#urlPrint").val();
            $("#cotizacion").val("Actualizar Cotizacion");
            $("#cotizacion1").val("Actualizar Cotizacion");
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data["message"] == "Successful") {
                    toastr["info"]("Cotizacion Guardada");
                    $("#id").val(data["id"]);
                    validarPrint();
                } else {
                    toastr["warning"](
